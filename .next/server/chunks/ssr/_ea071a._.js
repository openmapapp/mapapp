...
;
;
const PopupForm = ({ latitude, longitude, reportTypes, userId, trustScore, onClose })=>{
    ...
    const session = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authClient"].useSession();
    console.log(session);
...
function AddMarkerButton({ isAdding, toggleMarker }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        ...
        className: "absolute top-4 left-4 bg-blue-500 text-white rounded-full w-12 h-12 flex items-center justify-center shadow-lg hover:bg-blue-700 transition",
        children: isAdding ? "✖" : "+"
    }, void 0, false, {
...
//# sourceMappingURL=_ea071a._.js.map