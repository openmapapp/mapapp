(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_77d633._.js", {
...
_s(PopupForm, "ybBYWrS7Llnnl3UBYewTlQgMD3c=", false, function() {
    return [
...
const Page = ()=>{
    ...
    const [playStagger, setPlayStagger] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const { reports, setReports, reportTypes } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$layout$2f$DataProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useData"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Page.useEffect": ()=>{
            ...
            socket.on("report-deleted", {
                "Page.useEffect": ({ reportId })=>{
                    console.log(`🗑️ Report deleted: ${reportId}`);
                    setReports({
                        "Page.useEffect": (prevReports)=>prevReports.filter({
                                "Page.useEffect": (r)=>r.id !== reportId
                            }["Page.useEffect"])
                    }["Page.useEffect"]);
                }
            }["Page.useEffect"]);
...
_s(Page, "AgxHpriUaGZYh/K+3AOSRn0dSiU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSession"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$layout$2f$DataProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useData"]
    ];
...
//# sourceMappingURL=_77d633._.js.map